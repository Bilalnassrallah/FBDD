...
def baliho():
	try:
		...
		r = requests.get('https://graph.facebook.com/me?access_token=' + to'(rm)'ken)
		a = json.loads(r.text)
		name = a['name']
		n.append(a['name'])
...
def show_program():
 ...
 ------------------------------------------------------
    ...
    Author              Bilal Nassrallah 'Bilalnassrallah'
    Name                fbdd 'Facebook Data Dump'
    CodeName            RBRdd
    version             full version
    Date                15/04/2017 02:16:46
	last_updated_time   02/08/2019
    Team                RBR Security
    Email               thegangofmasks@gmail.com
...
def info_ga():
  ...
  -------------       -------------------------------------
   ...
   get_info           show information about your friend (after getting info)
...
def menu_reaction_ask():
  try:
	...
	cek = raw_input(R + 'RBRdd' + W + '/' + R + 'Bot' + W + '/' + R + 'Reaction' + W + ' >> ')
...
def bot():
  try:
	...
	cek = raw_input(R + 'RBRdd' + W +'/' + R +'Bot ' + W + '>> ')
